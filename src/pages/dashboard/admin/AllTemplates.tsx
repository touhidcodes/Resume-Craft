...
const AllTemplates = () => {
  ...
  const { data: allCoverLetterTemplates, isLoading } = useGetAllCoverLetterTemplateQuery("");
    ...
    <div>
      ...
      {isLoading ? (
        ...
        <div className=" mx-auto p-6">
          ...
          <h2 className="text-3xl font-bold text-gray-700 mb-6">All Resume Templates</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {allResumeTemplates?.data?.map((template: {
              id: string;
          ...
          <h2 className="text-3xl font-bold text-gray-700 mb-6">All Cover Letter Templates</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {allCoverLetterTemplates?.data?.map((template: {
              id: string;
              image: string | undefined;
              name: string
            },) => (
