import featureImage1 from "../../assets/images/f2.png"; // Replace
import featureImage2 from "../../assets/images/f.jpg"; // Replace
import featureImage3 from "../../assets/images/f3.jpg"; // Replace
    ...
    return (
        <div>
                ...
                <section className="container mx-auto px-6 grid gap-8 md:grid-cols-3 mb-16">
                    <div className="bg-white p-6 rounded-lg shadow-lg text-center">
                        ...
                        <p className="text-gray-600 mt-2">
                            Choose from a wide variety of modern and professional resume
                            templates designed to impress.
                        </p>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-lg text-center">
                        <img
                        ...
                        <p className="text-gray-600 mt-2">
                            Edit, format, and preview your resume live with an intuitive and
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg text-center">
                        ...
                        <p className="text-gray-600 mt-2">
                            Get expert tips and advice on what to include in your resume to
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="relative bg-white shadow-xl rounded-xl p-8 overflow-hidden">
                            ...
                            <p className="text-gray-600 mt-4 relative">
                                ...
                                strive to empower individuals in achieving their career goals with
                                ease and confidence.
                            </p>
                        </div>
                        ...
                        <div className="relative bg-white shadow-xl rounded-xl p-8 overflow-hidden">
                            ...
                            <p className="text-gray-600 mt-4 relative">
                                To become the most trusted and innovative resume builder globally,
                                enabling individuals to unlock their potential and connect with
            ...
            <div className="bg-gray-50 text-gray-800">
                ...
                <section className="py-16 bg-[#f2ebe6]">
                    <div className="container mx-auto px-6 md:px-12 lg:px-20">
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-12">
                            ...
                            <div className="bg-white rounded-lg shadow-md p-6 text-center transform hover:-translate-y-2 transition duration-300">
                                ...
                                />
                                <h3 className="text-2xl font-semibold text-[#003366]">John Doe</h3>
                            ...
                            <div className="bg-white rounded-lg shadow-md p-6 text-center transform hover:-translate-y-2 transition duration-300">
                                ...
                                <p className="text-gray-600 font-medium mb-4">Head of Product Design</p>
                                <p className="text-sm text-gray-500">
                                    Emily's creativity ensures our products are intuitive and visually
                                    stunning.
                                </p>
                            </div>
                            ...
                            <div className="bg-white rounded-lg shadow-md p-6 text-center transform hover:-translate-y-2 transition duration-300">
                                ...
                                <p className="text-sm text-gray-500">
                                    James provides expert career advice and helps our users succeed.
                                </p>
                            </div>
                        </div>
                    </div>
