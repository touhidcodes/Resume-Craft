...
const CoverLetterNameModal = ({ template }: { template: TTemplate }) => {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<TCoverLetterName>();
  const [createCoverLetter, { isLoading }] = useCreateCoverLetterMutation();
        ...
        <div className="fixed inset-0 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 bg-black/45">
            ...
            >
              ...
              >
                <h3 className="text-xl font-semibold">Cover letter name</h3>
                ...
                >
                  <div>
                    <Controller
                      name="name"
                      control={control}
                      rules={{ required: "Cover letter name is required" }}
...
export default CoverLetterNameModal;
